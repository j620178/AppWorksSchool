...
/*
 ...
 2.物件可以資料(如： let / var )與方法 (func) 封裝在一起，避免程式分散，不易閱讀之問題
...
//Answer6
/*
 1.instance method​： 實例方法建構於實體之上，需產生類別實體物件後，才能救呼叫使用
 2.type method： 類別方法建構於類別之上，無需產生出類別實體物件，即可使用。欲使用須於宣告方法前加上 static 關鍵字，如 static func()
 */
...
//Answer9
/*
 1.reference type： 使用『 = 』賦值的時候，是將記憶體位置賦予給另一個變數／常數，所以只要其中一個變數／常數更改，另一個亦會更改
 2.value type： 使用『 = 』賦值的時候，是複製一份一樣的內容賦予給另一個變數／常數，所以其中一個變數／常數更改，另一個不會更改
*/
